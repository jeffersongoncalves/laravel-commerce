...
namespace JeffersonGoncalves\Commerce\Admin\Tests;

use Illuminate\Foundation\Testing\RefreshDatabase;
use JeffersonGoncalves\Commerce\Admin\CommerceAdminServiceProvider;
...
abstract class TestCase extends Orchestra
{
    ...
    {
        return [
            CommerceAdminServiceProvider::class,
        ];
    }
    ...
    protected function defineDatabaseMigrations(): void
    {
        ...
        $tempPath = sys_get_temp_dir().'/laravel-commerce-admin-migrations';
