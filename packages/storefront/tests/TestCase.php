...
namespace JeffersonGoncalves\Commerce\Storefront\Tests;

use Illuminate\Foundation\Testing\RefreshDatabase;
use JeffersonGoncalves\Commerce\Storefront\CommerceStorefrontServiceProvider;
...
abstract class TestCase extends Orchestra
{
    ...
    protected array $migrationPackages = [
        ...
        'customer', 'region', 'sales-channel', 'tax', 'promotion', 'api-key',
    ];

    protected function getPackageProviders($app): array
    {
        return [
            CommerceStorefrontServiceProvider::class,
        ];
    }
    ...
    protected function defineDatabaseMigrations(): void
    {
        ...
        $tempPath = sys_get_temp_dir().'/laravel-commerce-storefront-migrations';
