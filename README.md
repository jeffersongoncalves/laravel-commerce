...
A Medusa-style headless commerce domain for Laravel — 21 isolated modules (catalog, pricing, inventory, cart, order, payment, fulfillment, tax, promotions and more) plus a saga workflow engine.
